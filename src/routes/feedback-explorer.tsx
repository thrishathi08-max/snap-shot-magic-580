...
function ExplorerPage() {
  ...
  const [days, setDays] =
    useState<DateRange>(90);

  const [rows, setRows] =
    useState<
      Awaited<
        ReturnType<typeof getFeedback>
      >
    >([]);
      ...
      <Panel className="mt-4">
        ...
        <div className="border-b border-border px-5 py-4">
          ...
          <PanelHeader
            ...
            subtitle={`${formatNumber(rows.length)} matching ${
              rows.length === 1
                ? "entry"
                : "entries"
            }`}
